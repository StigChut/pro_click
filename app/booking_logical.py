...
def logical_workflow_booking():
    ...
    try:
        ...
        while True:
            ...
            if not app.tools.safe_execute(
                app.tools.booking_default_satate,
                "Стартовая точка - ДА",
                "Стартовая точка - НЕТ",
                title
            ):
